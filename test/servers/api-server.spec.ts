...
describe("API Server", () => {
	...
	describe("POST /api/tools/relevant-questions", () => {
		it("should return relevant questions successfully", async () => {
			...
			const request = new Request(
				"http://localhost/api/tools/relevant-questions",
				{
					method: "POST",
	...
	describe("POST /api/tools/create-liveboard", () => {
		it("should create liveboard successfully", async () => {
			const mockLiveboardUrl =
				"https://test.thoughtspot.cloud/#/pinboard/liveboard-123";

			mockServiceInstance.fetchTMLAndCreateLiveboard.mockResolvedValue({
				url: mockLiveboardUrl,
			});
			...
			const requestBody = {
				...
				noteTile:
					"<h2>Revenue Dashboard</h2><p>This is a revenue dashboard</p>",
			};

			const request = new Request(
				"http://localhost/api/tools/create-liveboard",
				{
					method: "POST",
					headers: { "Content-Type": "application/json" },
					body: JSON.stringify(requestBody),
			...
			expect(
				mockServiceInstance.fetchTMLAndCreateLiveboard,
		...
		it("should handle service errors", async () => {
			...
			mockServiceInstance.fetchTMLAndCreateLiveboard.mockRejectedValue(
				mockError,
			);
	...
	describe("GET /api/resources/datasources", () => {
		it("should return datasources successfully", async () => {
			...
			const request = new Request(
				"http://localhost/api/resources/datasources",
				{
					method: "GET",
				},
			);
	...
	describe("POST /api/rest/2.0/*", () => {
		it("should proxy POST requests to ThoughtSpot API", async () => {
			...
			const request = new Request(
				"http://localhost/api/rest/2.0/test-endpoint",
				{
					method: "POST",
					headers: { "Content-Type": "application/json" },
					body: JSON.stringify(requestBody),
