...
// Kept in the test so a glossary edit that changes faceting is deliberate.
...
describe("terminology", () => {
	describe("resolveObjectTypeFacet", () => {
		...
		it("maps the Worksheet family to the worksheet facet", () => {
			...
			// "Model" is the current UI name for a Worksheet.
			expect(resolveObjectTypeFacet("model")).toBe("worksheet");
