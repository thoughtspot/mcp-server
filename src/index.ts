...
const oauthProvider = new OAuthProvider({
    apiHandlers: {
        ...
        '/openai/mcp': ThoughtSpotOpenAIDeepResearchMCP.serve("/openai/mcp") as any, // TODO: Remove 'any'
        '/openai/sse': ThoughtSpotOpenAIDeepResearchMCP.serveSSE("/openai/sse") as any, // TODO: Remove 'any'
