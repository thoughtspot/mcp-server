	...
	message: z
		...
		.describe(
			"A natural-language instruction for the model builder (e.g. 'create a model for sales from " +
				"the ORDERS table' or 'add a revenue measure'). Omit ONLY to fetch more updates for a turn " +
...
export const ModelUpdateSchema = z.object({
	...
	text: z
		...
		.optional()
		.describe(
			"Message text for text/text_chunk/notification updates, and the full plan markdown for " +
				"an mrd update.",
		),
	choice: z
		.any()
...
export const toolDefinitionsV3 = [
	...toolDefinitionsV2,
	{
		...
		description:
			...
			"- `mrd` — a proposed plan (Model Requirements Document): show it and get the user's approval " +
			"or changes before continuing. Nothing is built yet.\n" +
			"- `todo` / `notification` / `text` / `model_state` — progress and results: relay the " +
			"meaningful parts.\n" +
