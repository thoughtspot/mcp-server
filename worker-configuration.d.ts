/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 761bb93dc346ef4700789643906c5f12)
// Runtime types generated with workerd@1.20250428.0 2025-04-17 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		OAUTH_KV: KVNamespace;
		TS_ACCESS_TOKEN: string;
		TS_INSTANCE_URL: string;
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").ThoughtSpotMCP>;
		instanceUrl: SecretsStoreSecret;
		accessToken: SecretsStoreSecret;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TS_ACCESS_TOKEN" | "TS_INSTANCE_URL">> {}
}
